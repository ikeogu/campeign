...
export default function TermsAndConditions() {
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-brand-100">
            ...
            <nav className="bg-white border-b border-gray-100 py-6 sticky top-0 z-50">
                <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
                    ...
                    <Link
                        href={route('register')}
                        className="text-xs font-black uppercase tracking-widest text-gray-400 hover:text-brand-600 transition-colors"
                    >
                        Back to Signup
                    </Link>
                </div>
            ...
            <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
                {/* PAGE TITLE */}
                <div className="mb-12">
                    <span className="text-brand-600 font-black text-[10px] uppercase tracking-[0.3em] mb-3 block">
                        Legal Agreement
                    </span>
                    ...
                    <div className="bg-gray-50 rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-sm space-y-8">
                        ...
                        <section>
                            <h2 className="text-xl font-black text-gray-900 uppercase tracking-tight mb-4 flex items-center gap-3">
                                <span className="w-8 h-8 rounded-lg bg-brand-600 text-white flex items-center justify-center text-xs">1</span>
                        ...
                        <div className="pt-8 border-t border-gray-200">
                            <div className="bg-brand-50 border border-brand-100 p-6 rounded-3xl">
                                <h4 className="font-black text-brand-600 uppercase text-xs tracking-widest mb-2 text-center">Indemnification Clause</h4>
                                <p className="text-[13px] text-brand-900 font-bold leading-relaxed text-center italic">
