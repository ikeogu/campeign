...
<p style="margin:0 0 24px;font-size:15px;color:#6b7280;line-height:1.8;">
    Your campaign has been funded and is now visible to promoters. Shares and submissions will start coming in shortly.
</p>
    ...
    <tr>
        <td style="padding:20px 24px 12px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td style="padding:14px 0 8px;border-top:1px solid #e5e7eb;font-size:15px;font-weight:900;color:#1a1a4e;">Total Funded</td>
...
<p style="margin:0 0 28px;font-size:14px;color:#9ca3af;line-height:1.7;">
    Monitor your campaign performance and manage submissions from your dashboard.
</p>
